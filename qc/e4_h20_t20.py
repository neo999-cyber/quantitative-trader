# E4 implementation — variant e4_h20_t20: hold 20, top 0.20, mode top
# E4 implementation (docs/prereg/p2_pead_v1.md), loaded by qc/bootstrap_main.py at start:
...
def impl_initialize(self):
    ...
    self.hold = int(self.get_parameter("hold", "20"))
    self.top = float(self.get_parameter("top", "0.20"))
